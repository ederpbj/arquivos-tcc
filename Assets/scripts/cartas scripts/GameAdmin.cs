...
public class GameAdmin : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (congratulationsPanel == null) // Corrigido de parabenPanelController para congratulationsPanel
        {
            Debug.LogError("CongratulationsPanel não está atribuído no inspector!");
        }
